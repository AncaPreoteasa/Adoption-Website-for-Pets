        ...
        <>
          ...
          <Stack spacing={1} className={styles.skeleton}>
            ...
            <Skeleton
              ...
              height={30}
              width="25%"
              className={styles.skeletonBreed}
            />
            <Skeleton
              variant="rectangular"
              height={250}
              width="50%"
              className={styles.skeletonDogImage}
            />
            <Skeleton
              variant="rectangular"
              height={100}
              width="100%"
              className={styles.skeletonAbout}
            />
            <Skeleton
              variant="rectangular"
              height={30}
            ...
            <Skeleton
              ...
              height={30}
              width="10%"
              className={styles.skeletonLocation}
            />
            <Skeleton
              variant="rectangular"
              height={30}
              width="5%"
              className={styles.skeletonSize}
            />
            <Skeleton
              variant="rectangular"
              height={30}
              width="15%"
              className={styles.skeletonAge}
            />
            <Skeleton
              variant="rectangular"
              height={30}
              width="20%"
              className={styles.skeletonTrained}
            />
            <Skeleton
              variant="rectangular"
              height={30}
              width="10%"
              className={styles.skeletonAdopt}
            />
          </Stack>
        </>
      );
